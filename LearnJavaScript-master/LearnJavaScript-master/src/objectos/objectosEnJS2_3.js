/*
 * Crea dos objetos sobre cuadros que comparten una propiedad.
 * Las propiedades del primero objeto son: título, dimensión x y
 * dimensión y. Las del segundo son: título, autor, movimiento
 * artístico y técnica.
 * Cuando crees los objetos, escribe el título de forma
 * diferente en los dos objetos, por ejemplo, uno con artículos
 * y otro sin él. Para comprobar qué valor es el que perdura
 * después de la copia.
 * Resuélvelo de dos formas: con funciones y con el operador
 * spread.
 */
/**
 ...
 */
console.log(cuadro);
// # sourceMappingURL=eunciados5_ObjectosEnJS2_3.js.map
