...
function solicitarDNI(): void {
    ...
    if (dni != -1) {
        ...
        document.getElementById("DNI").innerHTML = letrasDNI.join(" ");
...
function fechaActual(): void {
    ...
    setTimeout(function(){ 
        ...
        document.getElementById("fechaActual").innerHTML = (fechaActual.getDate() + "/" + (fechaActual.getMonth() +1) + "/" + fechaActual.getFullYear()); }, 2000);
}
