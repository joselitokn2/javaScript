...
console.log(`Empleado con numero ${empleado["num emp"]} y dni ${empleado.dni}, tiene por nombre y apellido ${empleado.persona.nombre} ${empleado.persona.apellido}. El dni de la persona es ${empleado.persona.dni}`);
